...
| Bluetooth LE | Disabled in the application firmware; peer features use ESP-NOW | The independent Recovery partition provides the BLE install service | Application code must not link a Bluetooth host/controller; keep the Recovery partition intact |
